...
class TestMain(unittest.TestCase):
    ...
    def test_convert_repe_single_sign(self):
        ...
        # 々
        self.assertEqual("正正堂堂", convert_repe_single_sign("正々堂々"))
        self.assertEqual("段段", convert_repe_single_sign("段々"))
        self.assertEqual("赤裸裸", convert_repe_single_sign("赤裸々"))
        self.assertEqual("告別式式場", convert_repe_single_sign("告別式々場"))

        # 非正常输入测试
        self.assertEqual("正正堂", convert_repe_single_sign("正々堂"))
        self.assertEqual("々段", convert_repe_single_sign("々段"))
        self.assertEqual("々堂堂", convert_repe_single_sign("々堂々"))
        # TODO 极少数特例
        # self.assertEqual("複複複線", convert_repe_single_sign("複々々線"))
        # self.assertEqual("部分部分", convert_repe_single_sign("部分々々"))
        # TODO 古く（奈良時代）は記法が異なり
        # self.assertEqual("部分部分", convert_repe_single_sign("部々分々"))

        # 〻 現代では「〻」は「々」と書き換えられ、主に縦書きの文章に用いる。
        self.assertEqual("屡屡", convert_repe_single_sign("屡〻"))

        # ゝ 平仮名繰返し記号
        self.assertEqual("ここ", convert_repe_single_sign("こゝ"))
        self.assertEqual("こころ", convert_repe_single_sign("こゝろ"))
        self.assertEqual("わななかした", convert_repe_single_sign("わなゝかした"))

        # ヽ 片仮名繰返し記号
        self.assertEqual("ハハヽヽ", convert_repe_single_sign("ハヽヽヽ"))
        # 曾ては、妣 （ ハヽ ） が国として、恋慕の思ひをよせた此国は、現実の悦楽に満ちた楽土として、見かはすばかりに変つて了うた。
        # https://www.aozora.gr.jp/cards/000933/files/13212_14465.html
        self.assertEqual("ハハ", convert_repe_single_sign("ハヽ"))
    ...
    def test_convert_repe_single_daku_sign(self):
        ...
        self.assertEqual("ただ", convert_repe_single_daku_sign("たゞ"))
        self.assertEqual("みすず飴", convert_repe_single_daku_sign("みすゞ飴"))
        # FIXME 注意这个字符的定义：代表一个浊音假名，当前浊音符前的第一个假名就是浊音时，直接拼接返回即可
        # self.assertEqual("ぶぶ漬け", convert_repe_single_daku_sign("ぶゞ漬け"))
    ...
    def test_convert_repeated_double_sign(self):
        ...
        self.assertEqual("おのおの", convert_repe_double_sign("おの／＼"))
        # 〳〵
        self.assertEqual("おのおの", convert_repe_double_sign("おの〳〵"))
        self.assertEqual("くり返しくり返し", convert_repe_double_sign("くり返し〳〵"))
        # 〱
        self.assertEqual("見る見る", convert_repe_double_sign("見る〱"))
        # https://ja.wikipedia.org/wiki/%E8%B8%8A%E3%82%8A%E5%AD%97#%E3%80%B1%EF%BC%88%E3%81%8F%E3%81%AE%E5%AD%97%E7%82%B9%EF%BC%89
        self.assertEqual("どうしてどうして", convert_repe_double_sign("どうして〱"))
        # 非正常输入测试
        self.assertEqual("おの／＼肌", convert_repe_double_sign("おの／＼肌"))
    ...
    def test_convert_repeated_double_daku_sign(self):
        ...
        self.assertEqual("散り散り", convert_repe_double_daku_sign("散り〴〵"))
        self.assertEqual("代わる代わる", convert_repe_double_daku_sign("代わる〴〵"))
        # 请注意，这个样例并非来自真实的使用场景，仅用作测试
        self.assertEqual("かわるがわる", convert_repe_double_daku_sign("かわる〴〵"))
        # https://www.aozora.gr.jp/cards/001383/files/56641_59496.html
        # 彼は今始めて女の妙相みょうそうをしみ／″＼味わう事が出来た。
        self.assertEqual("しみじみ", convert_repe_double_daku_sign("しみ／″＼"))
        ...
        # self.assertEqual("だんだん", convert_repe_double_daku_sign("だん／＼"))
        # self.assertEqual("だんだん", convert_repe_double_daku_sign("だん／″＼"))
